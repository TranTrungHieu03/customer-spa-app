...
class TTextTheme {
  ...
  static TextTheme lightTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 15.0, fontWeight: FontWeight.w600, color: Colors.black),
    bodyMedium: const TextStyle().copyWith(fontSize: 15.0, fontWeight: FontWeight.w400, color: Colors.black),
    bodySmall: const TextStyle().copyWith(fontSize: 15.0, fontWeight: FontWeight.w400, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 20.0, fontWeight: FontWeight.w600, color: Colors.white),
