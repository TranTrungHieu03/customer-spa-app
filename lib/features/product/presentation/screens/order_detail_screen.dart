    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: BlocProvider(
            create: (context) => OrderBloc(getOrderProductDetail: serviceLocator(), createOrder: serviceLocator())
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                order.statusPayment == 'Cash' ? 'Thanh toán khi nhận hàng' : 'Chuyển khoản',
                        ...
                        children: [
                          ...
                          Text(
                              DateFormat('HH:mm, dd/MM/yyyy').format(
                                DateTime.parse(order.shipment?.orderTime ?? "").toUtc().toLocal(),
                              ),
                              style: Theme.of(context).textTheme.bodySmall)
                        ],
                      ),
                      if (order.status == 'Completed')
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                                DateFormat('HH:mm, dd/MM/yyyy').format(
                                  DateTime.parse(order.updatedDate ?? "").toUtc().toLocal(),
                                ),
                                style: Theme.of(context).textTheme.bodySmall)
                          ],
                        ),
