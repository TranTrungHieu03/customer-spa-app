...
class LocationRepositoryImpl implements LocationRepository {
  ...
  @override
  Future<Either<Failure, List<AddressModel>>> getAddress(GetAddressAutoCompleteParams params) async {
    try {
      final List<AddressModel> response = await _dataSource.getAddressAutoComplete(params);
      return right(response);
    } catch (e) {
      return left(ApiFailure(message: e.toString()));
    }
