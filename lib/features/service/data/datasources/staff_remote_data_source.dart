...
abstract class StaffRemoteDataSource {
  ...
  Future<List<StaffModel>> getStaffFreeInTime(GetStaffFreeInTimeParams param);
}
...
class StaffRemoteDataSourceImpl implements StaffRemoteDataSource {
  ...
  @override
  Future<List<StaffModel>> getStaffFreeInTime(GetStaffFreeInTimeParams param) async {
    try {
      final response = await _apiServices
          .getApi('/Staff/staff-free-in-time?BranchId=${param.branchId}&ServiceId=${param.serviceId}&StartTime=${param.startTime}');
