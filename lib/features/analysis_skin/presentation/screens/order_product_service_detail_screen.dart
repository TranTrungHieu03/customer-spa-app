                      ...
                      children: [
                        ...
                        TRoundedContainer(
                          ...
                          child: TPaymentDetailMix(
                              ...
                              promotePrice: order.voucher?.discountAmount ?? 0,
                              priceProduct: order.orderDetails?.fold(0.0, (a, b) => a! + ((b.quantity ?? 0) * (b.product.price ?? 0))) ?? 0,
                              priceService: order.appointments?.fold(0.0, (a, b) => a! + (b.service.price ?? 0)) ?? 0),
                        ),
