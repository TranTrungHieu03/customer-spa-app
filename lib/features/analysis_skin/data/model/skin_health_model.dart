...
class SkinHealthModel {
  ...
  static SkinHealthModel empty() => SkinHealthModel(
        skinColor: BlackheadModel(value: -1, confidence: 1),
        skinAge: SkinAgeModel(value: 0),
        leftEyelids: BlackheadModel(value: 0, confidence: 1),
        rightEyelids: BlackheadModel(value: 0, confidence: 1),
        eyePouch: BlackheadModel(value: 0, confidence: 1),
        darkCircle: BlackheadModel(value: 0, confidence: 1),
        foreheadWrinkle: BlackheadModel(value: 0, confidence: 1),
        crowsFeet: BlackheadModel(value: 0, confidence: 1),
        eyeFinelines: BlackheadModel(value: 0, confidence: 1),
        glabellaWrinkle: BlackheadModel(value: 0, confidence: 1),
        nasolabialFold: BlackheadModel(value: 0, confidence: 1),
        skinType: SkinTypeModel(skinType: -1, details: [
          BlackheadModel(value: 0, confidence: 1),
          BlackheadModel(value: 0, confidence: 1),
          BlackheadModel(value: 0, confidence: 1),
          BlackheadModel(value: 0, confidence: 1)
        ]),
        poresForehead: BlackheadModel(value: 0, confidence: 1),
        poresLeftCheek: BlackheadModel(value: 0, confidence: 1),
        poresRightCheek: BlackheadModel(value: 0, confidence: 1),
        poresJaw: BlackheadModel(value: 0, confidence: 1),
        blackhead: BlackheadModel(value: 0, confidence: 1),
